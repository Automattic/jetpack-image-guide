...
- Update expensive image weight determining operation to happen only when necessary.
...
[0.6.0-alpha]: https://github.com/Automattic/jetpack-image-guide/compare/v0.5.20...v0.6.0-alpha
